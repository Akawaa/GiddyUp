    ...
    <div class="row">
        ...
        <div class="col s3">
            <div class="collection">
                ...
                <a href="{{ url('/ratings/received') }}" class="collection-item active red darken-3">Avis reçus</a>
                <a href="{{ url('/ratings/given') }}" class="collection-item red-text text-darken-3">Avis laissés</a>
            </div>
        </div>
