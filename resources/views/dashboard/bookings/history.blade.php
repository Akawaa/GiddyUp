    ...
    <div class="row">
        ...
        <div class="col s3">
            <div class="collection">
                <a href="{{ url('/bookings') }}" class="collection-item red-text text-darken-3">En cours</a>
                <a href="{{ url('/bookings/history') }}" class="collection-item active red darken-3">Historique</a>
            </div>
        </div>
