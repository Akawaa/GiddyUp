...
<head>
    ...
    <style>table.facebook td{background:#3b5998;border-color:#2d4473;}table.facebook:hover td{background:#2d4473!important;}table.twitter td{background:#00acee;border-color:#0087bb;}table.twitter:hover td{background:#0087bb!important;}table.google-plus td{background-color:#DB4A39;border-color:#CC0000;}table.google-plus:hover td{background:#CC0000!important;}.template-label{color:#ffffff;font-weight:bold;font-size:11px;}.callout .panel{background:#ECF8FF;border-color:#b9e5ff;}.header{background:#999999;}.footer .wrapper{background:#ebebeb;}.footer h5{padding-bottom:10px;}table.columns .text-pad{padding-left:10px;padding-right:10px;}table.columns .left-text-pad{padding-left:10px;}table.columns .right-text-pad{padding-right:10px;}@media only screen and (max-width: 600px) {table[class="body"] .right-text-pad{padding-left:10px!important;}table[class="body"] .left-text-pad{padding-right:10px!important;}}
        @media only screen and (max-width: 600px){table.button, table.tiny-button, table.small-button, table.medium-button, table.large-button {overflow: hidden;margin-left: 50%;} table[class="body"] table.columns td.verif_email{height: 40px;line-height: 40px;}table.columns td, table.column td{padding:auto!important;}button tr.btn{height:20px;line-height:20px;}}</style>
</head>
<body>
<table class="body">
    <tr>
                                            ...
                                            <table class="twelve columns">
                                                <tr>
                                                    <td class="six sub-columns">
                                                        <img src="http://berenice-caly.fr/logo_giddyup.png" alt="logo" class="logo_img">
                                                    </td>
                                                    <td class="six sub-columns last" align="right" style="font-weight:bold;text-align:right; vertical-align:middle;">Modifiez votre mot de passe sur GiddyUp
                                                    </td>
                    ...
                    <tr>
                        <td>
                                ...
                                <tr>
                                    <td class="wrapper last">
                                        <table class="twelve columns">
                                            <tr>
                                                <td class="panel">
                                                    <p>Vous avez récemment sollicité une réinitialisation de votre mot de passe.</p>
                                                </td>
                                                <td class="expander"></td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td class="wrapper last">
                                        <table class="twelve columns">
                                            <tr>
                                                <td>
                                                    <p>Vous pouvez le modifier en cliquant sur le bouton suivant</p>
                                                </td>
                                                <td class="expander"></td>
                                            </tr>
                                        </table>
                                            ...
                                            <tr>
                                                <td>
                                                    <table class="button">
                                                        <tr>
                                                            <td class="btn">
                                                                <a href="{{ $link = url('password/reset', $token).'?email='.urlencode($user->getEmailForPasswordReset()) }}"> Réinitialiser mon mot de passe </a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                            ...
                            <table class="row footer">
                                ...
                                <p>L'équipe GiddyUp,</p>
                            </table>
                            <table class="row">
                                <tr>
                                    <td class="wrapper last">
                                    <td align="center" class="panel">
                                        <p>N'oubliez pas de télecharger notre application, disponible sous Android.<br><br>
                                            <img src="http://berenice-caly.fr/gp.png" alt="playstore" style="display:block;width:100%; max-width:100px;margin:0 auto;float:none">
                                    ...
                                    <table class="twelve columns">
                                        <tr>
                                            <td align="center">
                                                <center><br>
                                                    <p style="text-align:center;font-style:italic;font-size:10px;">Cet email vous a été envoyé par GiddyUp. </p>
                                                </center>
                                            </td>
                                            <td class="expander"></td>
                                        </tr>
